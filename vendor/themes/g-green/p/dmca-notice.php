 ...
 *
 * @package G-Silvers Landing Page
 * @subpackage tmdbtwo
 * @since TMDB Two 1.0
 */
...
<div class="row">
	<section id="primary" class="col-md-12">
		<article>
			...
			<div class="page-content">
				<p><?php echo site_path() ?> respects the intellectual property of others.</p>
   <p></p>
   <p><?php echo site_path() ?> takes matters of Intellectual Property very seriously and is committed to meeting the needs of content owners while helping them manage publication of their content online.</p>
   <p></p>
   <p>It should be noted that <?php echo site_path() ?> is a simple search engine of videos available at a wide variety websites.</p>
   <p></p>
   <p>Any videos shown on websites are the responsibility of those sites and not alivetv.info.</p>
   <p></p>
   ...
   <p></p>
   <p><?php echo site_path() ?> does not host any content on its servers or network.</p>
   <p></p>
   ...
   <p></p>
   <p>Attn: DMCA Office Contact Us : www.watchdogsecurity.online</p>
   <p></p>
   ...
   <p></p>
   <p>This information should not be construed as legal advice, for further details on the information required for valid DMCA notifications, see 17 U.S.C. 512(c)(3). 
